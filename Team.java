...
public class Team {
	...
	// ***************
	/*
	 * name = the tean's name. guesser = the last person on the team to answer a
	 * question (correctly or incorrectly) players = stores all of the players
	 * on the team. score = the team's score. guessed = true if the team has
	 * already answered the current question (reset every question).
	 */
	...
	public String toString() {
		return "Score: " + Integer.toString(score) + "; Players: "
				+ players.toString();
	}
